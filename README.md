...
<sub>$${\color{blue}*This software was not built by SAS&#xAE; Institute and uses no SAS&#xAE; components. It has no affiliation to SAS&#xAE; Institute.*}$$</sub>  
<sub>$${\color{blue}*SAS&#xAE; is a registered trademark of SAS Institute*}$$</sub>
